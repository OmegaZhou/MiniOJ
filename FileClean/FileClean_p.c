...
/* StartClean */
    { 
    /* StartClean */      /* procedure StartClean */
...
#pragma code_seg(".orpc")
static const FormatInfoRef IFileCleaner_Ndr64ProcTable[] =
    {
...
static const MIDL_SYNTAX_INFO IFileCleaner_SyntaxInfo [  2 ] = 
    {
    {
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    ...
    0,
    0 ,
    (unsigned short *) &IFileCleaner_Ndr64ProcTable[-3],
    0,
...
static const MIDL_STUBLESS_PROXY_INFO IFileCleaner_ProxyInfo =
    ...
    2,
    (MIDL_SYNTAX_INFO*)IFileCleaner_SyntaxInfo
...
static const MIDL_SERVER_INFO IFileCleaner_ServerInfo = 
    ...
    0,
    FileClean__MIDL_ProcFormatString.Format,
    (unsigned short *) &IFileCleaner_FormatStringOffsetTable[-3],
    0,
